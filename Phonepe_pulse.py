...
icon = Image.open("Your/image/path")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Sanjay HJ",
                   page_icon= icon,
                   layout= "wide",
...
# Repo.clone_from("https://github.com/PhonePe/pulse.git", "C:/Users/sanja/Downloads/phonepe project/pulse-master/data")
...
if selected == "Home":
    ...
    st.markdown("### :violet[Overview:] In this Streamlit web app, you can visualize the PhonePe Pulse data and gain a lot of insights on transactions, the number of users, top 10 states, districts, pincodes, and which brand has the most number of users, and so on. Bar charts, pie charts, and geomap visualization are used to obtain insights.")
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv("C:/Users/sanja/OneDrive/Documents/States.csv")
            df1.State = df2
...
if selected == "About":
        ...
        st.write("https://github.com/Sanjayhj43/Phonepe_pulse")
